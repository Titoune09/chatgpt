    ...
    <section id="technos" className="relative mx-auto mt-40 max-w-6xl px-6">
      <AuroraBackground className="p-12">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="font-display text-3xl text-chrome sm:text-4xl">Technos & valeur</h2>
          <p className="mt-4 text-base text-chrome/70">
            Panneaux en verre hexagonaux, halos et gradient aurora animé pour présenter stack et bénéfices.
          </p>
        </div>
        <div className="mt-12">
