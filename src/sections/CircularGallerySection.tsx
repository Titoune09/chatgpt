  ...
  return (
    <section id="gallery" className="relative mx-auto mt-40 max-w-6xl px-6">
      <div className="rounded-[3rem] border border-white/10 bg-steel/80 p-12 text-center shadow-subtle backdrop-blur">
        <h2 className="font-display text-3xl text-chrome sm:text-4xl">Moments de légende</h2>
        <p className="mx-auto mt-4 max-w-3xl text-base text-chrome/70">
          Faites défiler notre anneau interactif : warm-up au lever du soleil, runs nocturnes et ateliers garage en direct.
        </p>
        <div className="mt-12">
          <CircularGallery items={circularGalleryItems} centerContent={<span>1 200 tours partagés</span>} />
        </div>
      </div>
    </section>
  );
